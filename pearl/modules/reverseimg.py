...
#
""" Userbot module for searching stickers and images on Google """
...
from pearl.utils import errors_handler, register

opener = urllib.request.build_opener()
useragent = "Mozilla/5.0 (Linux; Android 9; SM-G960F Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.157 Mobile Safari/537.36"
opener.addheaders = [("BlackPearl", useragent)]


@register(outgoing=True, pattern=r"^.simg(?: |$)(\d*)")
@errors_handler
async def okgoogle(img):
    """ For .simg command, Google search images and stickers. """
