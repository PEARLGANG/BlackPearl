...
OFFICIAL_UPSTREAM_REPO = "https://github.com/PEARLGANG/BlackPearl"
BOT_IS_UP_TO_DATE = "BlackPearl userbot is up-to-date!"
NEW_BOT_UP_DATE_FOUND = (
    "**BlackPearl Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
@pearl.on(admin_cmd(pattern=r"update"))
...
@pearl.on(admin_cmd(pattern=r"sudoupdate", allow_sudo=True))
async def updater(message):
    try:
        repo = git.Repo()
    except git.exc.InvalidGitRepositoryError as e:
