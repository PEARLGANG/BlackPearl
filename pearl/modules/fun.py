...
@pearl.on(pearl_on_cmd(pattern="rapee ?(.*)"))
@pearl.on(sudo_cmd(pattern="rapee ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@pearl.on(pearl_on_cmd(pattern="insultt ?(.*)"))
@pearl.on(sudo_cmd(pattern="insultt ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@pearl.on(pearl_on_cmd(pattern="proo ?(.*)"))
@pearl.on(sudo_cmd(pattern="proo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@pearl.on(pearl_on_cmd(pattern="abusee ?(.*)"))
@pearl.on(sudo_cmd(pattern="abusee ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@pearl.on(pearl_on_cmd(pattern="gay ?(.*)"))
@pearl.on(sudo_cmd(pattern="gay ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    bro = random.randint(0, len(GAY_STRINGS) - 1)
    event.pattern_match.group(1)
    reply_text = GAY_STRINGS[bro]
    await edit_or_reply(event, reply_text)
