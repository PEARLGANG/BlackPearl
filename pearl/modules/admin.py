...
from pearl.utils import pearl_on_cmd, errors_handler, register, sudo_cmd
...
@pearl.on(pearl_on_cmd(pattern=r"promote(?: |$)(.*)"))
@pearl.on(sudo_cmd(pattern=r"promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@pearl.on(pearl_on_cmd(pattern=r"demote(?: |$)(.*)"))
@errors_handler
...
@pearl.on(pearl_on_cmd(pattern=r"ban(?: |$)(.*)"))
@errors_handler
async def ban(bon):
...
@pearl.on(pearl_on_cmd(pattern=r"unban(?: |$)(.*)"))
@errors_handler
...
@pearl.on(pearl_on_cmd(pattern=r"mute(?: |$)(.*)"))
@errors_handler
async def spider(spdr):
    ...
    try:
        from pearl.modules.sql_helper.spam_mute_sql import mute
...
@pearl.on(pearl_on_cmd(pattern=r"unmute(?: |$)(.*)"))
@errors_handler
async def unmoot(unmot):
    ...
    # Check if the function running under SQL mode
    try:
        from pearl.modules.sql_helper.spam_mute_sql import unmute
    except AttributeError:
...
async def muter(moot):
    ...
    try:
        ...
        from pearl.modules.sql_helper.spam_mute_sql import is_muted
    except AttributeError:
        return
...
@pearl.on(pearl_on_cmd(pattern=r"ungmute(?: |$)(.*)"))
@errors_handler
async def ungmoot(un_gmute):
    """ For .ungmute command, ungmutes the target in the pearl """
    # Admin or creator check
...
@pearl.on(pearl_on_cmd(pattern=r"gmute(?: |$)(.*)"))
@errors_handler
...
@pearl.on(pearl_on_cmd(pattern=r"delusers(?: |$)(.*)"))
@errors_handler
...
@pearl.on(pearl_on_cmd(pattern=r"adminlist"))
@errors_handler
...
@pearl.on(pearl_on_cmd(pattern=r"pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@pearl.on(pearl_on_cmd(pattern=r"kick(?: |$)(.*)"))
@errors_handler
async def kick(usr):
...
@pearl.on(pearl_on_cmd(pattern=r"users ?(.*)"))
@errors_handler
