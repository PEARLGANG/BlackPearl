...
""" Userbot module for managing events.
 One of the main components of the Black Pearl. """
...
from pearl import LOGSPAMMER, PRIVATE_GROUP_ID, bot
                ...
                if not disable_errors:
                    ...
                    if LOGSPAMMER:
                        await check.client.respond(
                            "`Sorry, Black Pearl has crashed.\
                        \nThe error logs are stored in the pearl's log chat.`"
                        )
